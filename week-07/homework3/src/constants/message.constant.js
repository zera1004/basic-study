import { MIN_PASSWORD_LENGTH } from './auth.constant.js'; // 패스워드 최소길이 import
import { MIN_RESUME_LENGTH } from './resume.constant.js'; // 이력서 최소길이 import

// message str 모음 export로 외부 파일에서 사용가능하게
